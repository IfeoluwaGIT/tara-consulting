...
const ContactCollectionForm = () => {
  ...
  return (
    <>
      <section className="min-h-screen flex flex-col lg:flex-row items-center justify-center bg-header-peach border text-text-color p-2 mt-10">
        {/* Image Section */}
        ...
        {/* Form Section */}
        <div className="bg-white p-2 shadow-lg rounded-lg w-full lg:w-1/2 mt-6 ">
