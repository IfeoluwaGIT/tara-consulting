  ...
  return (
    <section className="flex flex-col items-center justify-center px-6 py-12 md:px-12 lg:px-20 xl:px-[20%]">
      <div className="text-center">
        <h1 className="text-3xl md:text-4xl lg:text-4xl font-bold text-color mt-6 md:mt-8 lg:mt-10">
        ...
        <Link href="/about">
        <button className="px-4 py-2 md:px-6 md:py-3 bg-text-color text-white rounded hover:bg-button-hover">
          Learn More
        </button>
        </Link>
      </div>
